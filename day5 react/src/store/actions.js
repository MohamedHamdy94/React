...
export const Movies_Lng = 'Movies_Lng'
...
// };
export const movisLang = (lang) => (dispatch) => {
    return axios
        .get(`https://api.themoviedb.org/3/movie/popular?api_key=782991eb3d40e097f0473b979b9ae2e0&language=${lang}`)
        .then((res) => {
            console.log(res.data.results);
            dispatch({
                type: Movies_Lng,
